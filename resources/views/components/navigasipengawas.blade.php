<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('pengawas.beranda') }}">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('pengawas.beranda') ? 'active' : '' }}" href="{{ route('pengawas.beranda') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('pengawas.penilaianpk') ? 'active' : '' }}" href="{{ route('pengawas.penilaianpk') }}">
                    <div class="bg-gradient-info icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/foto/pk.png') }}" alt="Penilaian PM" width="50" height="50">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('pengawas.profilpengawas') ? 'active' : '' }}" href="{{ route('pengawas.profilpengawas') }}">
                    <div class="bg-gradient-info icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/foto/profil.png') }}" alt="Profil Pengawas" width="50" height="50">
                    </div>
