  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Selamat Datang di halaman Edit Data Pengawas</h6>
        </nav>
              ...
              <div class="p-4">
                <form id="formContainer">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                          ...
                          <select id="jabatan" class="form-select" required>
                            ...
                            <option value="Koordinator" selected>Koordinator</option> <!-- Example pre-selected -->
                  ...
                  <div class="d-flex justify-content-between mt-4">
                    ...
                    <!-- Tombol Kembali -->
                    <button type="button" class="btn btn-outline-secondary" onclick="window.location.href='datapengawas.html'">
                      Kembali
                    </button>
                  </div>
                </form>
    ...
    <script>
      ...
      document.getElementById('formContainer').addEventListener('submit', function(event) {
        ...
        // Redirection ke halaman sebelumnya (datapengawas.html)
